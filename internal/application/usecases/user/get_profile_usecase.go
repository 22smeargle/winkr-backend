...
func NewGetProfileUseCase(userRepo repositories.UserRepository, photoRepo repositories.PhotoRepository) *GetProfileUseCase {
...
func (uc *GetProfileUseCase) Execute(ctx context.Context, userID uuid.UUID) (*ProfileResponse, error) {
	// Get user
